...
public class MainController {
	...
	// 新規登録
	@GetMapping("/nuser")
	public String new_user(UserForm userForm, Model model) {
		return "nuser";
	}

	// 確認ページ
	@PostMapping("/finish")
	public String finish(@Validated UserForm userForm, BindingResult result, Model model) {
		if (result.hasErrors()) {
			return "nuser";
		}
		return "finish";
	...
	// 新規登録に戻る
	@PostMapping("/nuser")
	public String go_back(UserForm userForm, Model model) {
		return "nuser";
	}
	...
	@GetMapping("/mypage")
	public String mypage(UserForm userForm, Model model) {
	...
	@PostMapping("/index")
	public String index(@Validated LoginForm loginForm, UserForm userForm, BindingResult result, Model model,
			RedirectAttributes redirectAttributes) {
	...
	@GetMapping("/delete")
	public String delete(UserForm userForm, Model model, RedirectAttributes redirectAttributes, SessionStatus sessionStatus) {
		userService.delete(userForm.getId());
		sessionStatus.setComplete();
		redirectAttributes.addFlashAttribute("delete", "退会処理が完了しました。");
		return "redirect:/furicari/index";
	}
}
